...
export const DEFAULT_TABS: TabConfig[] = [
  ...
  { id: 'katplani', label: '2. 2D Kat Planı', shortLabel: 'Plan', icon: Compass, visible: true, order: 2, category: 'design' },
  { id: 'maliyet', label: '3. Maliyet Detayları', shortLabel: 'Maliyet', icon: BarChart3, visible: true, order: 3, category: 'finance' },
  { id: 'malikler', label: '4. Kat Malikleri & Ödemeler', shortLabel: 'Malikler', icon: Users, visible: true, order: 4, category: 'finance' },
  { id: 'teklif', label: '5. Teklif Çıktısı', shortLabel: 'Teklif', icon: FileText, visible: true, order: 5, category: 'docs' },
  { id: 'surec', label: '6. İnşaat & Süreç Takibi', shortLabel: 'Süreç', icon: Activity, visible: true, order: 6, category: 'docs' },
