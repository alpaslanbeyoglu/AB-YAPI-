      ...
      ...(params.useTotalLaborPrice ? [
        {
          id: 'k_total_labor',
          category: 'kaba',
          name: 'Kaba İnşaat Toplam İşçiliği (Kalıp-Demir-Duvar)',
          unit: 'm²',
          quantity: totalArea,
          unitPrice: Math.round((params.totalLaborUnitPrice || 0) * kabaFactor * 100) / 100,
          total: Math.round(totalArea * (Math.round((params.totalLaborUnitPrice || 0) * kabaFactor * 100) / 100) * 100) / 100,
          laborShare: 100,
