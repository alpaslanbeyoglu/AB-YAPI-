...
export const SolarAnalysisPanel: React.FC<SolarAnalysisPanelProps> = ({
  ...
  const isPlaying = onTogglePlay ? isPlayingProp : isPlayingInternal;
  const setIsPlaying = onTogglePlay ? onTogglePlay : setIsPlayingInternal;
  ...
  // Continuous play animation (Now managed by parent if onTogglePlay is provided)
  useEffect(() => {
  ...
  }, [isPlaying, onChangeTimeHour, onTogglePlay]);
