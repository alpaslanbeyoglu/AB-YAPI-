...
import { ProjectItem, INITIAL_PROJECTS } from '../utils/completedProjectsData';
  ...
  const [projects, setProjects] = useState<ProjectItem[]>(() => {
    try {
      ...
      if (saved) {
        ...
        // Filter out default projects from saved storage (based on IDs 1-22)
        // so that we always use the freshly updated INITIAL_PROJECTS for the defaults.
